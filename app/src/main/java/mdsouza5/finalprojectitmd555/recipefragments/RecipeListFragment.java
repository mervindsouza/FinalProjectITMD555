...
/*
* Main class for all Menu view on ShowPagesActivity class
* extended by all the other fragments
* */
...
public abstract class RecipeListFragment extends Fragment {
    ...
    * */
    ...
    // Star Clicked Event to check the occurrence of the database transaction
    ...
    // @return database reference when called for a instance
    public abstract Query GetQuery(DatabaseReference databaseReference);

    // @return string userId which is specific for each user generated by firebase
